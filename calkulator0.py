...
def make_digit_button(digit):
    return tk.Button(window,text=digit,bd=5,command=lambda:add_digit(digit))

def make_operation_button(operation):
    return tk.Button(window,text=operation,bd=5,font=('Arial',15),fg='red',command=lambda:add_operation(operation))
...
def make_calc_button(operation):
    return tk.Button(window,text=operation,bd=5,font=('Arial',15),fg='red',command=calculate)

def make_clear_button(operation):
    return tk.Button(window,text=operation,bd=5,font=('Arial',15),fg='red',command=clear)
